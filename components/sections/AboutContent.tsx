    ...
    <div className="pt-20 sm:pt-24">
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16 md:py-20">
        <div className="flex flex-col gap-8 sm:gap-12 md:flex-row md:items-start md:gap-16">
          <Reveal viewport={false} className="flex-shrink-0">
      ...
      <section className="section-glow bg-[var(--gradient-section)] py-12 sm:py-16 md:py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <Reveal as="h2" className="text-2xl font-semibold tracking-tight text-[var(--foreground)]">
            My Engineering Philosophy
          </Reveal>
          <Reveal delay={0.1} className="mt-8 space-y-6 text-[var(--muted-foreground)] leading-relaxed">
            <p className="text-lg">
      ...
      <section className="bg-[var(--background)] py-12 sm:py-16 md:py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          ...
          <Reveal as="ul" delay={0.1} className="mt-10 space-y-0">
            {experience.map((item) => (
              <li
                key={item.company}
